      ...
      <div className="container mx-auto px-6 lg:px-[60px] flex justify-between items-center">
        ...
        >
          <div className="relative w-12 h-12 flex items-center justify-center transition-all duration-300 hover:scale-105">
             <img src="./https://github.com/NaraChou/behavior-logic/blob/c68289452324bd67858efc7c7eac0fdc7993adef/logo.png" alt="行韋邏輯 Logo" className="w-full h-full object-contain drop-shadow-[0_0_15px_rgba(34,211,238,0.4)]" />
          </div>
